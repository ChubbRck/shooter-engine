...
//         {"quantity": "single", "type": "miniboss", "x": screens[4]+xSlots[5], "y": ySlots[2], "launchVel" : -300, "retreatPoint" : 20 , "bossFlag": false, "behaviorType": 1, "img": "miniboss-2"},
//         {"quantity": "single", "type": "miniboss", "x": screens[4]+xSlots[5], "y": ySlots[4], "launchVel" : -200, "retreatPoint" : 20 , "bossFlag": false, "behaviorType": 3, "img": "miniboss-3"},
...
var level2_data = {
    ...
    objects : [
        {"quantity": "wave", "type": "crosser", "how_many":5 , "x": screens[1]+xSlots[8], "y": ySlots[2], "baseVelocity": -220, "dirMod": 1},
        {"quantity": "wave", "type": "crosser", "how_many":5 , "x": screens[1]+xSlots[8], "y": ySlots[6], "baseVelocity": -220, "dirMod": -1},
        {"quantity": "single", "type": "powerup", "x": screens[1]+xSlots[5], "y": ySlots[4], "powerupType": "weapon"},
        {"quantity": "wave", "type": "crosser", "how_many":5 , "x": screens[2]+xSlots[0], "y": ySlots[4], "baseVelocity": -250, "dirMod": 1},
        {"quantity": "wave", "type": "crosser", "how_many":5 , "x": screens[2]+xSlots[0], "y": ySlots[4], "baseVelocity": -250, "dirMod": -1},
        {"quantity": "wave", "type": "crosser", "how_many":5 , "x": screens[2]+xSlots[5], "y": ySlots[1], "baseVelocity": -220, "dirMod": 1},
        {"quantity": "wave", "type": "crosser", "how_many":5 , "x": screens[2]+xSlots[5], "y": ySlots[7], "baseVelocity": -220, "dirMod": -1},
        {"quantity": "single", "type": "powerup", "x": screens[2]+xSlots[6], "y":ySlots[1], "powerupType": "lycocoin"},
        {"quantity": "single", "type": "powerup", "x": screens[2]+xSlots[6], "y":ySlots[5], "powerupType": "lycocoin"},
        {"quantity": "single", "type": "powerup", "x": screens[2]+xSlots[6], "y":ySlots[4], "powerupType": "lycocoin"},
        {"quantity": "single", "type": "powerup", "x": screens[2]+xSlots[6], "y":ySlots[3], "powerupType": "lycocoin"},
        {"quantity": "single", "type": "powerup", "x": screens[2]+xSlots[6], "y":ySlots[2], "powerupType": "lycocoin"},
        {"quantity": "single", "type": "powerup", "x": screens[2]+xSlots[6], "y":ySlots[6], "powerupType": "lycocoin"},
        {"quantity": "wave", "type": "sine", "how_many": 5, "x": screens[2]+xSlots[6], "y": ySlots[2], "baseVelocity": -225},
        {"quantity": "wave", "type": "sine", "how_many": 5, "x": screens[2]+xSlots[6], "y": ySlots[6], "baseVelocity": -225},
        {"quantity": "wave", "type": "sine", "how_many": 5, "x": screens[2]+xSlots[9], "y": ySlots[1], "baseVelocity": -225},
        {"quantity": "wave", "type": "sine", "how_many": 5, "x": screens[2]+xSlots[9], "y": ySlots[5], "baseVelocity": -225},
        {"quantity": "wave", "type": "sine", "how_many": 5, "x": screens[2]+xSlots[12], "y": ySlots[4], "baseVelocity": -225},
        {"quantity": "wave", "type": "crosser", "how_many":5 , "x": screens[3]+xSlots[3], "y": ySlots[2], "baseVelocity": -260, "dirMod": 1},
        {"quantity": "wave", "type": "crosser", "how_many":5 , "x": screens[3]+xSlots[3], "y": ySlots[6], "baseVelocity": -260, "dirMod": -1},
        {"quantity": "wave", "type": "enemy", "how_many": 5, "x": screens[3]+xSlots[8], "y": ySlots[1], "baseVelocity": -285},
        {"quantity": "wave", "type": "enemy", "how_many": 5, "x": screens[3]+xSlots[8], "y": ySlots[7], "baseVelocity": -285},
        {"quantity": "wave", "type": "enemy", "how_many": 5, "x": screens[4]+xSlots[1], "y": ySlots[1], "baseVelocity": -285},
        {"quantity": "wave", "type": "enemy", "how_many": 5, "x": screens[4]+xSlots[1], "y": ySlots[7], "baseVelocity": -285},
        {"quantity": "single", "type": "miniboss", "x": screens[4]+xSlots[5], "y": ySlots[2], "launchVel" : -300, "retreatPoint" : 20 , "bossFlag": false, "behaviorType": 1, "img": "miniboss-2"},
        {"quantity": "single", "type": "miniboss", "x": screens[4]+xSlots[5], "y": ySlots[4], "launchVel" : -200, "retreatPoint" : 20 , "bossFlag": false, "behaviorType": 3, "img": "miniboss-3"},
        {"quantity": "single", "type": "wall", "x": screens[3]+xSlots[5], "y": ySlots[4], "height":200, "width":300},
        {"quantity": "single", "type": "powerup", "x": screens[3]+xSlots[4], "y": ySlots[4], "powerupType": "lycocoin"},
        {"quantity": "single", "type": "wall", "x": screens[4]+xSlots[3], "y": ySlots[4], "height":200, "width":300},
        {"quantity": "single", "type": "powerup", "x": screens[4]+xSlots[2], "y": ySlots[3], "powerupType": "lycocoin"},
        {"quantity": "wave", "type": "crosser", "how_many":5 , "x": screens[4]+xSlots[5], "y": ySlots[1], "baseVelocity": -200, "dirMod": 1},
        {"quantity": "wave", "type": "crosser", "how_many":5 , "x": screens[4]+xSlots[5], "y": ySlots[5], "baseVelocity": -200, "dirMod": -1},
